        ...
        <div className={styles.top}>
          ...
          <div className={styles.social}>
            ...
            <div className={styles.socialIcons}>
              <a href="https://wa.me/573106463166" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="WhatsApp">
              ...
              <a href="https://instagram.com/whiptronix" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
